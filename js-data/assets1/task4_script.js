(() => {
    ...
    const input1 = document.querySelector('#task4_select_1')
    const input2 = document.querySelector('#task4_select_2')
    const input3 = document.querySelector('#task4_select_3')
    const input4 = document.querySelector('#task4_select_4')
    const input5 = document.querySelector('#task4_select_5')
    const input6 = document.querySelector('#task4_select_6')
